...
Future<void> main() async {
  ...
  Env.config = EnvConfig(
    ...
    authSignUpWebRedirectUrl: 'http://$host:3000/auth/callback',
    authPasswordRecoveryWebRedirectUrl: 'http://$host:3000/auth/callback',
    authSignUpAppRedirectUrl: 'taskly://auth-callback',
    authPasswordRecoveryAppRedirectUrl: 'taskly://auth-callback',
