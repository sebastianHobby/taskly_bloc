...
///
/// This is used when a value is associated with an entity (task/project)
/// through the junction tables (task_values, project_values). The [isPrimary]
/// flag indicates whether this is the primary value for the entity.
@immutable
