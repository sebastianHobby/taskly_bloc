...
mixin _$Tracker {
 ...
 String get id; String get name; TrackerResponseType get responseType; TrackerResponseConfig get config; TrackerEntryScope get entryScope; DateTime get createdAt; DateTime get updatedAt; String? get description; int get sortOrder;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,responseType,config,entryScope,createdAt,updatedAt,description,sortOrder);

@override
String toString() {
  return 'Tracker(id: $id, name: $name, responseType: $responseType, config: $config, entryScope: $entryScope, createdAt: $createdAt, updatedAt: $updatedAt, description: $description, sortOrder: $sortOrder)';
}
...
@useResult
$Res call({
 String id, String name, TrackerResponseType responseType, TrackerResponseConfig config, TrackerEntryScope entryScope, DateTime createdAt, DateTime updatedAt, String? description, int sortOrder
});
...
/// Create a copy of Tracker
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? responseType = null,Object? config = null,Object? entryScope = null,Object? createdAt = null,Object? updatedAt = null,Object? description = freezed,Object? sortOrder = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  TrackerResponseType responseType,  TrackerResponseConfig config,  TrackerEntryScope entryScope,  DateTime createdAt,  DateTime updatedAt,  String? description,  int sortOrder)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Tracker() when $default != null:
return $default(_that.id,_that.name,_that.responseType,_that.config,_that.entryScope,_that.createdAt,_that.updatedAt,_that.description,_that.sortOrder);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  TrackerResponseType responseType,  TrackerResponseConfig config,  TrackerEntryScope entryScope,  DateTime createdAt,  DateTime updatedAt,  String? description,  int sortOrder)  $default,) {final _that = this;
switch (_that) {
case _Tracker():
return $default(_that.id,_that.name,_that.responseType,_that.config,_that.entryScope,_that.createdAt,_that.updatedAt,_that.description,_that.sortOrder);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  TrackerResponseType responseType,  TrackerResponseConfig config,  TrackerEntryScope entryScope,  DateTime createdAt,  DateTime updatedAt,  String? description,  int sortOrder)?  $default,) {final _that = this;
switch (_that) {
case _Tracker() when $default != null:
return $default(_that.id,_that.name,_that.responseType,_that.config,_that.entryScope,_that.createdAt,_that.updatedAt,_that.description,_that.sortOrder);case _:
  return null;
...
class _Tracker implements Tracker {
  const _Tracker({required this.id, required this.name, required this.responseType, required this.config, required this.entryScope, required this.createdAt, required this.updatedAt, this.description, this.sortOrder = 0});
...
/// Create a copy of Tracker
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? responseType = null,Object? config = null,Object? entryScope = null,Object? createdAt = null,Object? updatedAt = null,Object? description = freezed,Object? sortOrder = null,}) {
