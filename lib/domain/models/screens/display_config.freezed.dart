...
mixin _$DisplayConfig {
 ...
 GroupByField get groupBy; List<SortCriterion> get sorting; List<ProblemType> get problemsToDetect; bool get showCompleted; bool get showArchived;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,groupBy,const DeepCollectionEquality().hash(sorting),const DeepCollectionEquality().hash(problemsToDetect),showCompleted,showArchived);

@override
String toString() {
  return 'DisplayConfig(groupBy: $groupBy, sorting: $sorting, problemsToDetect: $problemsToDetect, showCompleted: $showCompleted, showArchived: $showArchived)';
}
...
@useResult
$Res call({
 GroupByField groupBy, List<SortCriterion> sorting, List<ProblemType> problemsToDetect, bool showCompleted, bool showArchived
});
...
/// Create a copy of DisplayConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? groupBy = null,Object? sorting = null,Object? problemsToDetect = null,Object? showCompleted = null,Object? showArchived = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( GroupByField groupBy,  List<SortCriterion> sorting,  List<ProblemType> problemsToDetect,  bool showCompleted,  bool showArchived)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DisplayConfig() when $default != null:
return $default(_that.groupBy,_that.sorting,_that.problemsToDetect,_that.showCompleted,_that.showArchived);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( GroupByField groupBy,  List<SortCriterion> sorting,  List<ProblemType> problemsToDetect,  bool showCompleted,  bool showArchived)  $default,) {final _that = this;
switch (_that) {
case _DisplayConfig():
return $default(_that.groupBy,_that.sorting,_that.problemsToDetect,_that.showCompleted,_that.showArchived);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( GroupByField groupBy,  List<SortCriterion> sorting,  List<ProblemType> problemsToDetect,  bool showCompleted,  bool showArchived)?  $default,) {final _that = this;
switch (_that) {
case _DisplayConfig() when $default != null:
return $default(_that.groupBy,_that.sorting,_that.problemsToDetect,_that.showCompleted,_that.showArchived);case _:
  return null;
...
class _DisplayConfig implements DisplayConfig {
  const _DisplayConfig({this.groupBy = GroupByField.none, final  List<SortCriterion> sorting = const [], final  List<ProblemType> problemsToDetect = const [], this.showCompleted = true, this.showArchived = false}): _sorting = sorting,_problemsToDetect = problemsToDetect;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,groupBy,const DeepCollectionEquality().hash(_sorting),const DeepCollectionEquality().hash(_problemsToDetect),showCompleted,showArchived);
...
/// Create a copy of DisplayConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? groupBy = null,Object? sorting = null,Object? problemsToDetect = null,Object? showCompleted = null,Object? showArchived = null,}) {
