...
mixin _$AnalyticsInsight {
 ...
 String get id; InsightType get insightType; String get title; String get description; DateTime get generatedAt; DateTime get periodStart; DateTime get periodEnd; Map<String, dynamic> get metadata; double? get score;// 0-100 importance score
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,insightType,title,description,generatedAt,periodStart,periodEnd,const DeepCollectionEquality().hash(metadata),score,confidence,isPositive);

@override
String toString() {
  return 'AnalyticsInsight(id: $id, insightType: $insightType, title: $title, description: $description, generatedAt: $generatedAt, periodStart: $periodStart, periodEnd: $periodEnd, metadata: $metadata, score: $score, confidence: $confidence, isPositive: $isPositive)';
}
...
@useResult
$Res call({
 String id, InsightType insightType, String title, String description, DateTime generatedAt, DateTime periodStart, DateTime periodEnd, Map<String, dynamic> metadata, double? score, double? confidence, bool isPositive
});
...
/// Create a copy of AnalyticsInsight
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? insightType = null,Object? title = null,Object? description = null,Object? generatedAt = null,Object? periodStart = null,Object? periodEnd = null,Object? metadata = null,Object? score = freezed,Object? confidence = freezed,Object? isPositive = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  InsightType insightType,  String title,  String description,  DateTime generatedAt,  DateTime periodStart,  DateTime periodEnd,  Map<String, dynamic> metadata,  double? score,  double? confidence,  bool isPositive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AnalyticsInsight() when $default != null:
return $default(_that.id,_that.insightType,_that.title,_that.description,_that.generatedAt,_that.periodStart,_that.periodEnd,_that.metadata,_that.score,_that.confidence,_that.isPositive);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  InsightType insightType,  String title,  String description,  DateTime generatedAt,  DateTime periodStart,  DateTime periodEnd,  Map<String, dynamic> metadata,  double? score,  double? confidence,  bool isPositive)  $default,) {final _that = this;
switch (_that) {
case _AnalyticsInsight():
return $default(_that.id,_that.insightType,_that.title,_that.description,_that.generatedAt,_that.periodStart,_that.periodEnd,_that.metadata,_that.score,_that.confidence,_that.isPositive);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  InsightType insightType,  String title,  String description,  DateTime generatedAt,  DateTime periodStart,  DateTime periodEnd,  Map<String, dynamic> metadata,  double? score,  double? confidence,  bool isPositive)?  $default,) {final _that = this;
switch (_that) {
case _AnalyticsInsight() when $default != null:
return $default(_that.id,_that.insightType,_that.title,_that.description,_that.generatedAt,_that.periodStart,_that.periodEnd,_that.metadata,_that.score,_that.confidence,_that.isPositive);case _:
  return null;
...
class _AnalyticsInsight implements AnalyticsInsight {
  const _AnalyticsInsight({required this.id, required this.insightType, required this.title, required this.description, required this.generatedAt, required this.periodStart, required this.periodEnd, final  Map<String, dynamic> metadata = const {}, this.score, this.confidence, this.isPositive = true}): _metadata = metadata;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,insightType,title,description,generatedAt,periodStart,periodEnd,const DeepCollectionEquality().hash(_metadata),score,confidence,isPositive);
...
/// Create a copy of AnalyticsInsight
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? insightType = null,Object? title = null,Object? description = null,Object? generatedAt = null,Object? periodStart = null,Object? periodEnd = null,Object? metadata = null,Object? score = freezed,Object? confidence = freezed,Object? isPositive = null,}) {
