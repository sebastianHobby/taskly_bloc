...
Widget buildDefaultRoutineEditor(
  ...
  return RoutineDetailSheetPage(
    ...
    routineChecklistRepository: args.routineChecklistRepository,
    projectRepository: args.projectRepository,
