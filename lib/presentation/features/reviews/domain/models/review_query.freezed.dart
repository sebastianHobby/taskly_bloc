...
mixin _$ReviewQuery {
 ...
 EntityType get entityType; List<String>? get projectIds; List<String>? get labelIds; List<String>? get valueIds; bool? get includeCompleted; bool? get includeArchived; DateTime? get completedBefore; DateTime? get completedAfter; DateTime? get createdBefore; DateTime? get createdAfter; int? get limit;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,entityType,const DeepCollectionEquality().hash(projectIds),const DeepCollectionEquality().hash(labelIds),const DeepCollectionEquality().hash(valueIds),includeCompleted,includeArchived,completedBefore,completedAfter,createdBefore,createdAfter,limit);

@override
String toString() {
  return 'ReviewQuery(entityType: $entityType, projectIds: $projectIds, labelIds: $labelIds, valueIds: $valueIds, includeCompleted: $includeCompleted, includeArchived: $includeArchived, completedBefore: $completedBefore, completedAfter: $completedAfter, createdBefore: $createdBefore, createdAfter: $createdAfter, limit: $limit)';
}
...
@useResult
$Res call({
 EntityType entityType, List<String>? projectIds, List<String>? labelIds, List<String>? valueIds, bool? includeCompleted, bool? includeArchived, DateTime? completedBefore, DateTime? completedAfter, DateTime? createdBefore, DateTime? createdAfter, int? limit
});
...
/// Create a copy of ReviewQuery
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? entityType = null,Object? projectIds = freezed,Object? labelIds = freezed,Object? valueIds = freezed,Object? includeCompleted = freezed,Object? includeArchived = freezed,Object? completedBefore = freezed,Object? completedAfter = freezed,Object? createdBefore = freezed,Object? createdAfter = freezed,Object? limit = freezed,}) {
...
as bool?,includeArchived: freezed == includeArchived ? _self.includeArchived : includeArchived // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( EntityType entityType,  List<String>? projectIds,  List<String>? labelIds,  List<String>? valueIds,  bool? includeCompleted,  bool? includeArchived,  DateTime? completedBefore,  DateTime? completedAfter,  DateTime? createdBefore,  DateTime? createdAfter,  int? limit)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReviewQuery() when $default != null:
return $default(_that.entityType,_that.projectIds,_that.labelIds,_that.valueIds,_that.includeCompleted,_that.includeArchived,_that.completedBefore,_that.completedAfter,_that.createdBefore,_that.createdAfter,_that.limit);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( EntityType entityType,  List<String>? projectIds,  List<String>? labelIds,  List<String>? valueIds,  bool? includeCompleted,  bool? includeArchived,  DateTime? completedBefore,  DateTime? completedAfter,  DateTime? createdBefore,  DateTime? createdAfter,  int? limit)  $default,) {final _that = this;
switch (_that) {
case _ReviewQuery():
return $default(_that.entityType,_that.projectIds,_that.labelIds,_that.valueIds,_that.includeCompleted,_that.includeArchived,_that.completedBefore,_that.completedAfter,_that.createdBefore,_that.createdAfter,_that.limit);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( EntityType entityType,  List<String>? projectIds,  List<String>? labelIds,  List<String>? valueIds,  bool? includeCompleted,  bool? includeArchived,  DateTime? completedBefore,  DateTime? completedAfter,  DateTime? createdBefore,  DateTime? createdAfter,  int? limit)?  $default,) {final _that = this;
switch (_that) {
case _ReviewQuery() when $default != null:
return $default(_that.entityType,_that.projectIds,_that.labelIds,_that.valueIds,_that.includeCompleted,_that.includeArchived,_that.completedBefore,_that.completedAfter,_that.createdBefore,_that.createdAfter,_that.limit);case _:
  return null;
...
class _ReviewQuery implements ReviewQuery {
  const _ReviewQuery({required this.entityType, final  List<String>? projectIds, final  List<String>? labelIds, final  List<String>? valueIds, this.includeCompleted, this.includeArchived, this.completedBefore, this.completedAfter, this.createdBefore, this.createdAfter, this.limit}): _projectIds = projectIds,_labelIds = labelIds,_valueIds = valueIds;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,entityType,const DeepCollectionEquality().hash(_projectIds),const DeepCollectionEquality().hash(_labelIds),const DeepCollectionEquality().hash(_valueIds),includeCompleted,includeArchived,completedBefore,completedAfter,createdBefore,createdAfter,limit);
...
/// Create a copy of ReviewQuery
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? entityType = null,Object? projectIds = freezed,Object? labelIds = freezed,Object? valueIds = freezed,Object? includeCompleted = freezed,Object? includeArchived = freezed,Object? completedBefore = freezed,Object? completedAfter = freezed,Object? createdBefore = freezed,Object? createdAfter = freezed,Object? limit = freezed,}) {
