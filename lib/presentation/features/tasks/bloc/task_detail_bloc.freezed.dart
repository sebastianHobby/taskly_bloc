...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String id,  String name,  String? description,  bool completed,  DateTime? startDate,  DateTime? deadlineDate,  String? projectId,  String? repeatIcalRrule,  bool isNextAction,  int? nextActionPriority,  String? nextActionNotes,  List<Label>? labels)?  update,TResult Function( String id)?  delete,TResult Function( String name,  String? description,  bool completed,  DateTime? startDate,  DateTime? deadlineDate,  String? projectId,  String? repeatIcalRrule,  bool isNextAction,  int? nextActionPriority,  String? nextActionNotes,  List<Label>? labels)?  create,TResult Function( String taskId)?  get,TResult Function()?  loadInitialData,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaskDetailUpdate() when update != null:
return update(_that.id,_that.name,_that.description,_that.completed,_that.startDate,_that.deadlineDate,_that.projectId,_that.repeatIcalRrule,_that.isNextAction,_that.nextActionPriority,_that.nextActionNotes,_that.labels);case _TaskDetailDelete() when delete != null:
return delete(_that.id);case _TaskDetailCreate() when create != null:
return create(_that.name,_that.description,_that.completed,_that.startDate,_that.deadlineDate,_that.projectId,_that.repeatIcalRrule,_that.isNextAction,_that.nextActionPriority,_that.nextActionNotes,_that.labels);case _TaskDetailGet() when get != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String id,  String name,  String? description,  bool completed,  DateTime? startDate,  DateTime? deadlineDate,  String? projectId,  String? repeatIcalRrule,  bool isNextAction,  int? nextActionPriority,  String? nextActionNotes,  List<Label>? labels)  update,required TResult Function( String id)  delete,required TResult Function( String name,  String? description,  bool completed,  DateTime? startDate,  DateTime? deadlineDate,  String? projectId,  String? repeatIcalRrule,  bool isNextAction,  int? nextActionPriority,  String? nextActionNotes,  List<Label>? labels)  create,required TResult Function( String taskId)  get,required TResult Function()  loadInitialData,}) {final _that = this;
switch (_that) {
case _TaskDetailUpdate():
return update(_that.id,_that.name,_that.description,_that.completed,_that.startDate,_that.deadlineDate,_that.projectId,_that.repeatIcalRrule,_that.isNextAction,_that.nextActionPriority,_that.nextActionNotes,_that.labels);case _TaskDetailDelete():
return delete(_that.id);case _TaskDetailCreate():
return create(_that.name,_that.description,_that.completed,_that.startDate,_that.deadlineDate,_that.projectId,_that.repeatIcalRrule,_that.isNextAction,_that.nextActionPriority,_that.nextActionNotes,_that.labels);case _TaskDetailGet():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String id,  String name,  String? description,  bool completed,  DateTime? startDate,  DateTime? deadlineDate,  String? projectId,  String? repeatIcalRrule,  bool isNextAction,  int? nextActionPriority,  String? nextActionNotes,  List<Label>? labels)?  update,TResult? Function( String id)?  delete,TResult? Function( String name,  String? description,  bool completed,  DateTime? startDate,  DateTime? deadlineDate,  String? projectId,  String? repeatIcalRrule,  bool isNextAction,  int? nextActionPriority,  String? nextActionNotes,  List<Label>? labels)?  create,TResult? Function( String taskId)?  get,TResult? Function()?  loadInitialData,}) {final _that = this;
switch (_that) {
case _TaskDetailUpdate() when update != null:
return update(_that.id,_that.name,_that.description,_that.completed,_that.startDate,_that.deadlineDate,_that.projectId,_that.repeatIcalRrule,_that.isNextAction,_that.nextActionPriority,_that.nextActionNotes,_that.labels);case _TaskDetailDelete() when delete != null:
return delete(_that.id);case _TaskDetailCreate() when create != null:
...
class _TaskDetailUpdate implements TaskDetailEvent {
  const _TaskDetailUpdate({required this.id, required this.name, required this.description, required this.completed, this.startDate, this.deadlineDate, this.projectId, this.repeatIcalRrule, this.isNextAction = false, this.nextActionPriority, this.nextActionNotes, final  List<Label>? labels}): _labels = labels;
...
@JsonKey() final  bool isNextAction;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TaskDetailUpdate&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.completed, completed) || other.completed == completed)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.deadlineDate, deadlineDate) || other.deadlineDate == deadlineDate)&&(identical(other.projectId, projectId) || other.projectId == projectId)&&(identical(other.repeatIcalRrule, repeatIcalRrule) || other.repeatIcalRrule == repeatIcalRrule)&&(identical(other.isNextAction, isNextAction) || other.isNextAction == isNextAction)&&(identical(other.nextActionPriority, nextActionPriority) || other.nextActionPriority == nextActionPriority)&&(identical(other.nextActionNotes, nextActionNotes) || other.nextActionNotes == nextActionNotes)&&const DeepCollectionEquality().equals(other._labels, _labels));
}


@override
int get hashCode => Object.hash(runtimeType,id,name,description,completed,startDate,deadlineDate,projectId,repeatIcalRrule,isNextAction,nextActionPriority,nextActionNotes,const DeepCollectionEquality().hash(_labels));

@override
String toString() {
  return 'TaskDetailEvent.update(id: $id, name: $name, description: $description, completed: $completed, startDate: $startDate, deadlineDate: $deadlineDate, projectId: $projectId, repeatIcalRrule: $repeatIcalRrule, isNextAction: $isNextAction, nextActionPriority: $nextActionPriority, nextActionNotes: $nextActionNotes, labels: $labels)';
}
...
@useResult
$Res call({
 String id, String name, String? description, bool completed, DateTime? startDate, DateTime? deadlineDate, String? projectId, String? repeatIcalRrule, bool isNextAction, int? nextActionPriority, String? nextActionNotes, List<Label>? labels
});
...
/// Create a copy of TaskDetailEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? description = freezed,Object? completed = null,Object? startDate = freezed,Object? deadlineDate = freezed,Object? projectId = freezed,Object? repeatIcalRrule = freezed,Object? isNextAction = null,Object? nextActionPriority = freezed,Object? nextActionNotes = freezed,Object? labels = freezed,}) {
...
as String?,isNextAction: null == isNextAction ? _self.isNextAction : isNextAction // ignore: cast_nullable_to_non_nullable
as bool,nextActionPriority: freezed == nextActionPriority ? _self.nextActionPriority : nextActionPriority // ignore: cast_nullable_to_non_nullable
as int?,nextActionNotes: freezed == nextActionNotes ? _self.nextActionNotes : nextActionNotes // ignore: cast_nullable_to_non_nullable
...
class _TaskDetailCreate implements TaskDetailEvent {
  const _TaskDetailCreate({required this.name, required this.description, this.completed = false, this.startDate, this.deadlineDate, this.projectId, this.repeatIcalRrule, this.isNextAction = false, this.nextActionPriority, this.nextActionNotes, final  List<Label>? labels}): _labels = labels;
...
@override
int get hashCode => Object.hash(runtimeType,name,description,completed,startDate,deadlineDate,projectId,repeatIcalRrule,isNextAction,nextActionPriority,nextActionNotes,const DeepCollectionEquality().hash(_labels));

@override
String toString() {
  return 'TaskDetailEvent.create(name: $name, description: $description, completed: $completed, startDate: $startDate, deadlineDate: $deadlineDate, projectId: $projectId, repeatIcalRrule: $repeatIcalRrule, isNextAction: $isNextAction, nextActionPriority: $nextActionPriority, nextActionNotes: $nextActionNotes, labels: $labels)';
}
...
@useResult
$Res call({
 String name, String? description, bool completed, DateTime? startDate, DateTime? deadlineDate, String? projectId, String? repeatIcalRrule, bool isNextAction, int? nextActionPriority, String? nextActionNotes, List<Label>? labels
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( List<Project> availableProjects,  List<Label> availableLabels)?  initialDataLoadSuccess,TResult Function( EntityOperation operation)?  operationSuccess,TResult Function( DetailBlocError<Task> errorDetails)?  operationFailure,TResult Function()?  loadInProgress,TResult Function( List<Project> availableProjects,  List<Label> availableLabels,  Task task)?  loadSuccess,required TResult orElse(),}) {final _that = this;
switch (_that) {
case TaskDetailInitial() when initial != null:
return initial();case TaskDetailInitialDataLoadSuccess() when initialDataLoadSuccess != null:
return initialDataLoadSuccess(_that.availableProjects,_that.availableLabels);case TaskDetailOperationSuccess() when operationSuccess != null:
...
return loadSuccess(_that.availableProjects,_that.availableLabels,_that.task);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function( List<Project> availableProjects,  List<Label> availableLabels)  initialDataLoadSuccess,required TResult Function( EntityOperation operation)  operationSuccess,required TResult Function( DetailBlocError<Task> errorDetails)  operationFailure,required TResult Function()  loadInProgress,required TResult Function( List<Project> availableProjects,  List<Label> availableLabels,  Task task)  loadSuccess,}) {final _that = this;
switch (_that) {
case TaskDetailInitial():
return initial();case TaskDetailInitialDataLoadSuccess():
return initialDataLoadSuccess(_that.availableProjects,_that.availableLabels);case TaskDetailOperationSuccess():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function( List<Project> availableProjects,  List<Label> availableLabels)?  initialDataLoadSuccess,TResult? Function( EntityOperation operation)?  operationSuccess,TResult? Function( DetailBlocError<Task> errorDetails)?  operationFailure,TResult? Function()?  loadInProgress,TResult? Function( List<Project> availableProjects,  List<Label> availableLabels,  Task task)?  loadSuccess,}) {final _that = this;
switch (_that) {
case TaskDetailInitial() when initial != null:
return initial();case TaskDetailInitialDataLoadSuccess() when initialDataLoadSuccess != null:
return initialDataLoadSuccess(_that.availableProjects,_that.availableLabels);case TaskDetailOperationSuccess() when operationSuccess != null:
...
class TaskDetailInitialDataLoadSuccess implements TaskDetailState {
  const TaskDetailInitialDataLoadSuccess({required final  List<Project> availableProjects, required final  List<Label> availableLabels}): _availableProjects = availableProjects,_availableLabels = availableLabels;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TaskDetailInitialDataLoadSuccess&&const DeepCollectionEquality().equals(other._availableProjects, _availableProjects)&&const DeepCollectionEquality().equals(other._availableLabels, _availableLabels));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_availableProjects),const DeepCollectionEquality().hash(_availableLabels));

@override
String toString() {
  return 'TaskDetailState.initialDataLoadSuccess(availableProjects: $availableProjects, availableLabels: $availableLabels)';
}
...
@useResult
$Res call({
 List<Project> availableProjects, List<Label> availableLabels
});
...
/// Create a copy of TaskDetailState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? availableProjects = null,Object? availableLabels = null,}) {
...
as List<Project>,availableLabels: null == availableLabels ? _self._availableLabels : availableLabels // ignore: cast_nullable_to_non_nullable
as List<Label>,
  ));
}
...
class TaskDetailLoadSuccess implements TaskDetailState {
  const TaskDetailLoadSuccess({required final  List<Project> availableProjects, required final  List<Label> availableLabels, required this.task}): _availableProjects = availableProjects,_availableLabels = availableLabels;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TaskDetailLoadSuccess&&const DeepCollectionEquality().equals(other._availableProjects, _availableProjects)&&const DeepCollectionEquality().equals(other._availableLabels, _availableLabels)&&(identical(other.task, task) || other.task == task));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_availableProjects),const DeepCollectionEquality().hash(_availableLabels),task);

@override
String toString() {
  return 'TaskDetailState.loadSuccess(availableProjects: $availableProjects, availableLabels: $availableLabels, task: $task)';
}
...
@useResult
$Res call({
 List<Project> availableProjects, List<Label> availableLabels, Task task
});
...
/// Create a copy of TaskDetailState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? availableProjects = null,Object? availableLabels = null,Object? task = null,}) {
