...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String userId)?  loadTrackers,TResult Function( Tracker tracker)?  saveTracker,TResult Function( String trackerId)?  deleteTracker,TResult Function( String userId,  List<String> trackerIds)?  reorderTrackers,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoadTrackers() when loadTrackers != null:
return loadTrackers(_that.userId);case _SaveTracker() when saveTracker != null:
...
return reorderTrackers(_that.userId,_that.trackerIds);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String userId)  loadTrackers,required TResult Function( Tracker tracker)  saveTracker,required TResult Function( String trackerId)  deleteTracker,required TResult Function( String userId,  List<String> trackerIds)  reorderTrackers,}) {final _that = this;
switch (_that) {
case _LoadTrackers():
return loadTrackers(_that.userId);case _SaveTracker():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String userId)?  loadTrackers,TResult? Function( Tracker tracker)?  saveTracker,TResult? Function( String trackerId)?  deleteTracker,TResult? Function( String userId,  List<String> trackerIds)?  reorderTrackers,}) {final _that = this;
switch (_that) {
case _LoadTrackers() when loadTrackers != null:
return loadTrackers(_that.userId);case _SaveTracker() when saveTracker != null:
return saveTracker(_that.tracker);case _DeleteTracker() when deleteTracker != null:
...
class _LoadTrackers implements TrackerManagementEvent {
  const _LoadTrackers(this.userId);
...
_$LoadTrackersCopyWith<_LoadTrackers> get copyWith => __$LoadTrackersCopyWithImpl<_LoadTrackers>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoadTrackers&&(identical(other.userId, userId) || other.userId == userId));
}
...
@override
String toString() {
  return 'TrackerManagementEvent.loadTrackers(userId: $userId)';
}
...
/// @nodoc
abstract mixin class _$LoadTrackersCopyWith<$Res> implements $TrackerManagementEventCopyWith<$Res> {
  factory _$LoadTrackersCopyWith(_LoadTrackers value, $Res Function(_LoadTrackers) _then) = __$LoadTrackersCopyWithImpl;
@useResult
$Res call({
 String userId
});
...
/// @nodoc
class __$LoadTrackersCopyWithImpl<$Res>
    implements _$LoadTrackersCopyWith<$Res> {
  __$LoadTrackersCopyWithImpl(this._self, this._then);

  final _LoadTrackers _self;
  final $Res Function(_LoadTrackers) _then;

/// Create a copy of TrackerManagementEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? userId = null,}) {
  return _then(_LoadTrackers(
...
class _ReorderTrackers implements TrackerManagementEvent {
  const _ReorderTrackers(this.userId, final  List<String> trackerIds): _trackerIds = trackerIds;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReorderTrackers&&(identical(other.userId, userId) || other.userId == userId)&&const DeepCollectionEquality().equals(other._trackerIds, _trackerIds));
}


@override
int get hashCode => Object.hash(runtimeType,userId,const DeepCollectionEquality().hash(_trackerIds));

@override
String toString() {
  return 'TrackerManagementEvent.reorderTrackers(userId: $userId, trackerIds: $trackerIds)';
}
...
@useResult
$Res call({
 String userId, List<String> trackerIds
});
...
/// Create a copy of TrackerManagementEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? trackerIds = null,}) {
  return _then(_ReorderTrackers(
null == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as String,null == trackerIds ? _self._trackerIds : trackerIds // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
