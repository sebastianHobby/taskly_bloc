...
typedef _ChildBaselineGetter =
    double Function(RenderBox child, BoxConstraints constraints);
...
class _BorderContainerState extends State<_BorderContainer>
  ...
  void initState() {
    ...
    _hoverColorTween = ColorTween(
      begin: widget.hoverColor.withAlpha(0),
...
class _HelperErrorState extends State<_HelperError>
  ...
  Widget _buildError() {
    ...
    if (capturedError != null && widget.errorStyle != null) {
      capturedError = DefaultTextStyle(
...
class _RenderDecoration extends RenderBox
  ...
  _SubtextSize? _computeSubtextSizes({
    ...
    final double ascent =
        math.max(
          counterAscent,
          getBaseline(helperError, helperErrorConstraints),
        ) +
        subtextGap;
  ...
  _RenderDecorationLayout _layout(
    ...
    final double iconWidth = icon == null
        ? 0.0
        : layoutChild(icon, boxConstraints).width;
    ...
    final Size prefixSize = prefix == null
        ? Size.zero
        : layoutChild(prefix, contentConstraints);
    final Size suffixSize = suffix == null
        ? Size.zero
        : layoutChild(suffix, contentConstraints);
    ...
    final double prefixBaseline = prefix == null
        ? 0.0
        : getBaseline(prefix, contentConstraints);
    final double suffixBaseline = suffix == null
        ? 0.0
        : getBaseline(suffix, contentConstraints);
    ...
    final double maxContainerHeight = math.max(
      0.0,
  ...
  double computeMinIntrinsicHeight(double width) {
    ...
    width = math.max(
      width - contentPadding.horizontal - decoration.inputGap * 2,
      0.0,
    );
    ...
    final double helperErrorAvailableWidth = math.max(
      width - counterWidth - counterPadding,
      0.0,
    );
  ...
  void performLayout() {
    ...
    final double helperErrorBaseline = helperError.getDistanceToBaseline(
      TextBaseline.alphabetic,
    )!;
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (label != null) {
      ...
      final double floatEndX = lerpDouble(
        floatStartX,
        centeredFloatX,
        floatAlign,
      )!;
  ...
  ChildSemanticsConfigurationsResult _childSemanticsConfigurationDelegate(
    ...
    for (final childConfig in childConfigs) {
      ...
      if (tag != null) {
        mergeGroups
            .putIfAbsent(tag, () => <SemanticsConfiguration>[])
            .add(childConfig);
      } else {
...
class InputDecorator extends StatefulWidget {
  ...
  static RenderBox? containerOf(BuildContext context) {
    final _RenderDecoration? result = context
        .findAncestorRenderObjectOfType<_RenderDecoration>();
...
class _InputDecoratorState extends State<InputDecorator>
      ...
      if (decoration.filled!) {
        ...
        return border.copyWith(
          borderSide: WidgetStateProperty.resolveAs(
            decorationTheme.activeIndicatorBorder ??
  ...
  Widget build(BuildContext context) {
    ...
    final VisualDensity visualDensity =
        decoration.visualDensity ?? themeData.visualDensity;
      ...
      counter = Semantics(
        ...
        child: Text(
          ...
          style: _getHelperStyle(themeData, defaults).merge(
            WidgetStateProperty.resolveAs(decoration.counterStyle, widgetState),
          ),
          overflow: TextOverflow.ellipsis,
    ...
    final EdgeInsets? resolvedPadding = decoration.contentPadding?.resolve(
      textDirection,
    );
    ...
    if (useMaterial3) {
      if (border is OutlineInputBorder) {
        ...
        inputGap = border.isOutline || (decoration.filled ?? false)
            ? _kInputExtraPadding
            : 0.0;
      }
    }
...
class InputDecorationTheme extends InheritedTheme with Diagnosticable {
  ...
  TextStyle? get helperStyle =>
      _data != null ? _data.helperStyle : _helperStyle;
  ...
  int? get helperMaxLines =>
      _data != null ? _data.helperMaxLines : _helperMaxLines;
  ...
  Duration? get hintFadeDuration =>
      _data != null ? _data.hintFadeDuration : _hintFadeDuration;
  ...
  int? get errorMaxLines =>
      _data != null ? _data.errorMaxLines : _errorMaxLines;
  ...
  TextStyle? get prefixStyle =>
      _data != null ? _data.prefixStyle : _prefixStyle;
  ...
  Color? get prefixIconColor =>
      _data != null ? _data.prefixIconColor : _prefixIconColor;
  ...
  TextStyle? get suffixStyle =>
      _data != null ? _data.suffixStyle : _suffixStyle;
  ...
  Color? get suffixIconColor =>
      _data != null ? _data.suffixIconColor : _suffixIconColor;
  ...
  TextStyle? get counterStyle =>
      _data != null ? _data.counterStyle : _counterStyle;
  ...
  BorderSide? get outlineBorder =>
      _data != null ? _data.outlineBorder : _outlineBorder;
  ...
  InputBorder? get errorBorder =>
      _data != null ? _data.errorBorder : _errorBorder;
  ...
  InputBorder? get focusedBorder =>
      _data != null ? _data.focusedBorder : _focusedBorder;
  ...
  InputBorder? get disabledBorder =>
      _data != null ? _data.disabledBorder : _disabledBorder;
  ...
  InputBorder? get enabledBorder =>
      _data != null ? _data.enabledBorder : _enabledBorder;
  ...
  BoxConstraints? get constraints =>
      _data != null ? _data.constraints : _constraints;
  ...
  VisualDensity? get visualDensity =>
      _data != null ? _data.visualDensity : _visualDensity;
  ...
  InputDecorationTheme merge(InputDecorationTheme? other) {
    ...
    return copyWith(
      ...
      activeIndicatorBorder:
          activeIndicatorBorder ?? other.activeIndicatorBorder,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      IntProperty(
        'hintMaxLines',
        hintMaxLines,
        defaultValue: defaultTheme.hintMaxLines,
      ),
    );
    properties.add(
      DiagnosticsProperty<TextStyle>(
