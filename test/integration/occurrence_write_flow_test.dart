...
void main() {
  ...
  testSafe(
    'task occurrence writes persist and forward OperationContext',
    () async {
  ...
  testSafe(
    'project occurrence writes persist and forward OperationContext',
    () async {
      final db = createTestDb();
      addTearDown(() => closeTestDb(db));
  ...
  testSafe(
    'task occurrence uncomplete and series operations persist',
    () async {
      final db = createTestDb();
      addTearDown(() => closeTestDb(db));
