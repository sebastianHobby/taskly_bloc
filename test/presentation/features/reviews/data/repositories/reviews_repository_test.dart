...
void main() {
  ...
  group('ReviewsRepository - Basic CRUD', () {
    ...
    test('getDueReviews returns only reviews due now or earlier', () async {
      final now = DateTime(2025, 1, 20, 12);
      ...
      // Note: This test is time-sensitive. In real implementation,
      // we'd need to mock DateTime.now() or make the method accept a date parameter
      expect(
  ...
  group('ReviewsRepository - Query Persistence', () {
    test('saves and retrieves review with complex query', () async {
      ...
      expect(retrieved.query.includeArchived, false);
    ...
    test('saves review with label query', () async {
      ...
      expect(retrieved.query.limit, 10);
    });
  });
